...
export const Todolist = React.memo(function ({demo = false, ...props}: PropsType) {
  ...
  const addTask = useCallback((title: string) =>
    props.addTask(title, props.todolist.id), [props.todolist.id, props.addTask])
  
  const removeTodolist = useCallback(() =>
    props.removeTodolist(props.todolist.id), [props.todolist.id, props.removeTodolist])
  
  const changeTodolistTitle = useCallback((title: string) =>
    props.changeTodolistTitle(props.todolist.id, title), [props.todolist.id, props.changeTodolistTitle])
    ...
    <div>
      {
        tasksForTodolist.map(t =>
          <Task
            key={t.id} task={t} todolistId={props.todolist.id}
